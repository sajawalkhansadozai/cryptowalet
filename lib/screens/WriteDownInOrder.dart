...
class _WriteDownInOrderState extends State<WriteDownInOrder> {
  ...
  // Function to create a single recovery phrase container with the same text
  ...
  Widget build(BuildContext context) {
    String repeatedText = "sample"; // The text to be repeated in all boxes
    ...
    return Scaffold(
      body: Column(
        ...
        children: [
          ...
          buildStepper(_currentStep, _onStepTapped),
                  ...
                  return Padding(
                    ...
                    child: Row(
                      ...
                      children: List.generate(3, (colIndex) {
                        return buildRecoveryContainer(repeatedText);
                      }),
                    ),
                  );
                }),
